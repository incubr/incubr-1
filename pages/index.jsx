...
export default function Home() {
  const { seconds, canShow } = React.useContext(Store);
const defaultOptions = {
  ...
  return (
    <div className="w-full scroll-smooth">
      {canShow && (
        <div className="fixed  loading-animation top-0 left-0 h-screen w-full bg-[#1D1D1D] z-[100]">
          ...
          <div className="flex w-full font-[PPNeueMontreal] lg:absolute bottom-20 justify-center">
            <div className="flex w-[85%] items-end justify-center flex-col">
              <div className=" cursor-pointer w-24 lg:w-36 relative h-24 lg:h-36 flex flex-col items-center justify-between">
