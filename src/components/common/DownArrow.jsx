...
export default function DownArrow({title, isDark=false}) {
  return (
    <div className="flex w-full lg:absolute h-[18vh] sm:h-[20vh] lg:h-auto bottom-10 justify-center">
      <div className="flex w-[85%] justify-center lg:justify-end">
        ...
        >
          ...
          <h1 className={`font-bold text-xl ${isDark ? "text-white": " text-black"} mt-[2vw] lg:mt-0 lg:text-[1.6vw] font-[PPNeueMontreal] tracking-widest`}>
            {title}
          </h1>
        </div>
      </div>
