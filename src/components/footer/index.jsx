    ...
    <div className="w-full flex flex-col items-center">
      ...
      <footer className="h-screen px-10  space-y-10 lg:space-y-[2vw] w-full sm:w-[80%] lg:w-[80%] flex flex-col lg:flex-row items-center justify-center">
        <div className="flex flex-col space-y-10 lg:space-y-[3vw] justify-start items-start">
          ...
          <div className="flex w-full">
            <div className="flex flex-1 ">
              <div className="button flex space-y-2 lg:space-y-[1.5vw] flex-col text-xl cursor-pointer font-[PPNeueMontreal] tracking-wider lg:text-[1.7vw] text-black opacity-50">
        ...
        <div className="flex flex-col space-y-10 w-full items-center sm:items-start ">
          <button className="button transition-colors w-full sm:w-auto duration-200 ease-in-out hover:shadow-md hover:bg-[#F0C808] hover:text-black font-[PPNeueMontreal] p-3 sm:p-5 rounded-full  text-2xl lg:text-[2.5vw] px-8 bg-[#110A0A] text-white">
            START A PROJECT
          </button>
          ...
          <div className=" text-black tracking-wider font-[PPNeueMontreal] opacity-50 text-2xl lg:text-[1.5vw]">
