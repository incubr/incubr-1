...
const CarosuelController = () => {
  const swiper = useSwiper();
  return (
    <div className="flex w-full pt-[8vw] sm:pt-[7vw] lg:pt-[4vw] items-center justify-center lg:justify-start">
      <div
        onClick={() => swiper.slidePrev()}
        className="hidden lg:flex rounded-xl cursor-pointer rotate-180 items-center justify-center bg-white bg-opacity-25 h-[10vw] w-[10vw] sm:w-[6vw] sm:h-[6vw] lg:h-[3vw] lg:w-[3vw]"
      >
        <svg
          viewBox="0 0 12 22"
      ...
      <div
        ...
        className="hidden lg:flex rounded-xl cursor-pointer  lg:ml-3 items-center justify-center bg-white bg-opacity-25 h-[10vw] w-[10vw] sm:w-[6vw] sm:h-[6vw] lg:h-[3vw] lg:w-[3vw]"
      >
        <svg
          viewBox="0 0 12 22"
          className="h-[4vw] sm:h-[3vw] lg:h-[1vw]"
