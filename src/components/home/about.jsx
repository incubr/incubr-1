  ...
  return (
    ...
    >
      <div className="flex w-full flex-col sm:flex-row">
        <div className="w-[100%] flex flex-col sm:flex-row px-6 lg:px-0">
          <div className="flex flex-[1.5] items-center jus lg:-mt-[5vw]">
            ...
            <h1 className=" text-6xl lg:text-[7vw] font-[Arial] flex-1 cursor-pointer">
              WE DO
            </h1>
          </div>
          <div className="flex flex-1 flex-col text-lg text-center lg:text-start lg:text-[1.5vw]">
            <div className="flex flex-col w-auto font-[PPNeueMontreal] mt-10">
              ...
              <div
                ...
                className="flex text-white mt-16 cursor-pointer justify-center sm:justify-start transition-colors ease-in-out duration-200 hover:text-[#F0C808]  font-bold tracking-wider"
              >
